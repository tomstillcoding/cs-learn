...
> 本文档来自：[go-awesome](https://github.com/shockerli/go-awesome)
>
...
## 指导原则
- 简单性：复杂性把可读的程序变得不可读，复杂性终结了很多软件项目。
  
- 可读性：代码是给人看的，代码阅读时长远超编写。程序必须可维护，那可读是第一步。
  
- 生产率：拥有众多的工具集和基础库，可以很简单方便的完成绝大多数工作。
